...
def upgrade() -> None:
    ...
    # Use conditional drops for fresh databases where these tables may not exist
    conn = op.get_bind()
    
    # Check and drop chat_history table and index
    ...
    # Check and drop checkpoints table and index
    ...
    # Check and drop checkpoint_migrations table
    ...
    # Check and drop checkpoint_blobs table and index
    ...
    # Check and drop checkpoint_writes table and index
